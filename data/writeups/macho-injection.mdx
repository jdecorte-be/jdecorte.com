...
draft: false
images: ['/static/images/portfolio/woody/main.avif']
summary: "Building a Mach-O packer for macOS ARM64 binaries: dynamic library injection, binary manipulation, and the internal structure of macOS executables."
---
...
<div style={{ backgroundColor: '#d3d3d3', padding: '1rem', borderRadius: '0.5rem' }}>
  <Image src="/static/images/writeups/macho-injection/1.avif" alt="description" width={800} height={400} />
</div>
...
<Image src="/static/images/writeups/macho-injection/2.avif" alt="description" width={800} height={400} />
...
<Image src="/static/images/writeups/macho-injection/3.avif" alt="description" width={800} height={400} />
